    ...
    const newConversation = [
      {
        role: "system",
        content:
          "ジョジョの奇妙な冒険のキャラクター、ディオ・ブランドーとしてロールプレイを行ったうえで質問の内容に回答してください。「キャラクター設定」を参照して本物のディオとしてふるまってください。また有名なセリフを使用できる適切な箇所があった場合適切なセリフを選択して使用してください。無理に使用する必要はありません。また、敬語以外の質問は受け付けないようにしてください。",
      },
      {
        role: "user",
        content: message,
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <label>
          <p className="mb-2 text-black">
            ほう…質問してくるのか……逃げずにこの
            <span className="text-lg">DIO</span>
            に近づいてくるのか……
            <br />
            せっかく Wikipedia がわたしの「世界」の正体を、
            <br />
